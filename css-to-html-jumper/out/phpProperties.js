...
exports.phpFunctions = void 0;
exports.phpFunctions = {
    // ==================== PHP配列 ====================
    "array_map": {
        name: "array_map",
        category: "PHP配列",
    ...
    "wp_head": { name: "wp_head", category: "追加辞書", description: "" },
    "wp_footer": { name: "wp_footer", category: "追加辞書", description: "" },
    "body_class": { name: "body_class", category: "追加辞書", description: "" },
    "post_class": { name: "post_class", category: "追加辞書", description: "" },
    "the_category": { name: "the_category", category: "追加辞書", description: "" },
    "the_tags": { name: "the_tags", category: "追加辞書", description: "" },
    "get_header": { name: "get_header", category: "追加辞書", description: "" },
    "get_footer": { name: "get_footer", category: "追加辞書", description: "" },
    "get_sidebar": { name: "get_sidebar", category: "追加辞書", description: "" },
    "get_template_part": { name: "get_template_part", category: "追加辞書", description: "" },
    "dynamic_sidebar": { name: "dynamic_sidebar", category: "追加辞書", description: "" },
    "is_active_sidebar": { name: "is_active_sidebar", category: "追加辞書", description: "" },
    "register_sidebar": { name: "register_sidebar", category: "追加辞書", description: "" },
    "register_nav_menus": { name: "register_nav_menus", category: "追加辞書", description: "" },
    "wp_nav_menu": { name: "wp_nav_menu", category: "追加辞書", description: "" },
    "add_theme_support": { name: "add_theme_support", category: "追加辞書", description: "" },
...
//# sourceMappingURL=phpProperties.js.map